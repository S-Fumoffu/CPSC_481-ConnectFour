...
from colors import *
from fonts import *
from button import Button  # your Button class
...
# Create Buttons
pvp_button = Button(si_game=type('', (), {'screen': screen})(), msg="Player vs Player", pos=(400, 200))
pvai_button = Button(si_game=type('', (), {'screen': screen})(), msg="Player vs AI", pos=(400, 300))

easy_button = Button(si_game=type('', (), {'screen': screen})(), msg="Easy", pos=(400, 200))
medium_button = Button(si_game=type('', (), {'screen': screen})(), msg="Medium", pos=(400, 300))
hard_button = Button(si_game=type('', (), {'screen': screen})(), msg="Hard", pos=(400, 400))
